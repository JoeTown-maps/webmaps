...
var format_tl_2025_29021_roads_1 = new ol.format.GeoJSON();
var features_tl_2025_29021_roads_1 = format_tl_2025_29021_roads_1.readFeatures(json_tl_2025_29021_roads_1, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_tl_2025_29021_roads_1 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_tl_2025_29021_roads_1.addFeatures(features_tl_2025_29021_roads_1);
var lyr_tl_2025_29021_roads_1 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_tl_2025_29021_roads_1, 
                style: style_tl_2025_29021_roads_1,
                popuplayertitle: 'tl_2025_29021_roads',
                interactive: false,
    title: 'tl_2025_29021_roads<br />\
    <img src="styles/legend/tl_2025_29021_roads_1_0.png" /> Interstate<br />\
    <img src="styles/legend/tl_2025_29021_roads_1_1.png" /> US Highway<br />\
    <img src="styles/legend/tl_2025_29021_roads_1_2.png" /> Business Loop<br />' });
...
var lyr_SaintJosephBoundary_2 = new ol.layer.Vector({
                ...
                interactive: false,
                title: '<img src="styles/legend/SaintJosephBoundary_2.png" /> SaintJosephBoundary'
            });
...
var lyr_StJosephHistoricDistricts_3 = new ol.layer.Vector({
                ...
                popuplayertitle: 'StJosephHistoricDistricts',
                interactive: true,
    title: 'StJosephHistoricDistricts<br />\
...
lyr_ESRIStandard_0.setVisible(true);lyr_tl_2025_29021_roads_1.setVisible(true);lyr_SaintJosephBoundary_2.setVisible(true);lyr_StJosephHistoricDistricts_3.setVisible(true);lyr_MissouriRiver_4.setVisible(true);
var layersList = [lyr_ESRIStandard_0,lyr_tl_2025_29021_roads_1,lyr_SaintJosephBoundary_2,lyr_StJosephHistoricDistricts_3,lyr_MissouriRiver_4];
lyr_tl_2025_29021_roads_1.set('fieldAliases', {'LINEARID': 'LINEARID', 'FULLNAME': 'FULLNAME', 'RTTYP': 'RTTYP', 'MTFCC': 'MTFCC', });
...
lyr_tl_2025_29021_roads_1.set('fieldImages', {'LINEARID': 'TextEdit', 'FULLNAME': 'TextEdit', 'RTTYP': 'TextEdit', 'MTFCC': 'TextEdit', });
...
lyr_StJosephHistoricDistricts_3.set('fieldImages', {'fid': 'TextEdit', 'HST_NAME': 'TextEdit', 'OTHR_NAME': 'TextEdit', 'MPS_MRA': 'TextEdit', 'COMMENT_': 'TextEdit', 'PERIOD_SIG': 'TextEdit', 'ARCHITECT': 'TextEdit', 'PADDRESS': 'TextEdit', 'PLOCALNAME': 'TextEdit', 'DATE_LIST': 'DateTime', });
lyr_MissouriRiver_4.set('fieldImages', {'OBJECTID': '', 'PRIVBND_': '', 'PRIVBND_ID': '', 'SHAPE.STArea()': '', 'SHAPE.STLength()': '', });
lyr_tl_2025_29021_roads_1.set('fieldLabels', {'LINEARID': 'no label', 'FULLNAME': 'no label', 'RTTYP': 'no label', 'MTFCC': 'no label', });
...
lyr_StJosephHistoricDistricts_3.set('fieldLabels', {'fid': 'hidden field', 'HST_NAME': 'no label', 'OTHR_NAME': 'hidden field', 'MPS_MRA': 'hidden field', 'COMMENT_': 'hidden field', 'PERIOD_SIG': 'hidden field', 'ARCHITECT': 'hidden field', 'PADDRESS': 'no label', 'PLOCALNAME': 'hidden field', 'DATE_LIST': 'header label - visible with data', });
