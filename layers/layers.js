...
lyr_StJosephHistoricDistricts_3.set('fieldLabels', {'fid': 'hidden field', 'HST_NAME': 'no label', 'OTHR_NAME': 'hidden field', 'MPS_MRA': 'hidden field', 'COMMENT_': 'hidden field', 'PERIOD_SIG': 'hidden field', 'ARCHITECT': 'hidden field', 'PADDRESS': 'no label', 'PLOCALNAME': 'hidden field', 'DATE_LIST': 'no label', });
